...
//Test Data - Task 2
createTicket('Robert Joseph', 'Credentials Does Not Exist in Portal', 'High'); 
 createTicket('Alex Smith', 'Cannot Find Printer', 'Medium'); 
 createTicket('Taylor Morgan', 'System Functioning, just running slow.', 'Low');
